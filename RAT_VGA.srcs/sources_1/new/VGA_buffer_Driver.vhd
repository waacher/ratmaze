...
-- vga driver signals
signal ra            : std_logic_vector(12 downto 0)    := (others=>'0');     -- Read Address line
signal vgaData       : std_logic_vector(7 downto 0)     := (others=>'0');     -- VGA 8-bit color code
signal fb_wr         : std_logic     := '0';                                 -- Frame Buffer write enable
signal vgaclk        : std_logic     := '0';                                 -- 25.175 MHz VGA clock     
signal red, green    : std_logic_vector(2 downto 0)     := (others=>'0');    -- 3-bit red and green color codes
signal blue          : std_logic_vector(1 downto 0)     := (others=>'0');    -- 3-bit blue color code
signal row, column   : std_logic_vector(9 downto 0)     := (others=>'0');    -- 10-bit row and column 
